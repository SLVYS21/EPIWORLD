      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center">
            <img
              ...
              alt="User avatar" />
            <div className="ml-3">
              <p className="text-sm font-medium text-gray-900 dark:text-white">{post.loser.name}</p>
              <p className="text-sm text-gray-500 dark:text-gray-400">{post.position}</p>
            </div>
          </div>
        </div><div className="relative pb-[100%]">
            <img
            ...
            <p className="text-sm font-medium text-gray-900 dark:text-white mb-1">{post.name}</p>
